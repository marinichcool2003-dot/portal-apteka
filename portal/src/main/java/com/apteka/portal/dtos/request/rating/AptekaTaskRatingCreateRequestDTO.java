...
@Schema(description = "Запрос на создание оценки аптеки по задаче")
public record AptekaTaskRatingCreateRequestDTO(
        @Schema(description = "Оценка от 1 до 5 звёзд", example = "5")
